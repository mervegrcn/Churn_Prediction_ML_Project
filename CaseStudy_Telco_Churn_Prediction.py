...
df = pd.read_csv("/Users/mervegurcan/PycharmProjects/pythonProject/MachineLearning/Datasets/Telco-Customer-Churn.csv")
df.head()
df.shape
df.info()

# pd.to_numeric() fonksiyonu, belirtilen bir sütunu veya seriyi sayısal formata dönüştürür.
# Dönüşüm sırasında oluşan hatalarda errors='coerce' parametresi kullanılarak, hatalı dönüşümler yerine NaN (Not a Number) değeri atanır.
